...
public:
    ...
    QLabel *label_from_name;
    QTextEdit *from_text_edit;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        to_text_edit->setGeometry(QRect(104, 60, 341, 31));
        ...
        label_from_name = new QLabel(centralWidget);
        label_from_name->setObjectName(QStringLiteral("label_from_name"));
        label_from_name->setGeometry(QRect(70, 30, 31, 16));
        from_text_edit = new QTextEdit(centralWidget);
        from_text_edit->setObjectName(QStringLiteral("from_text_edit"));
        from_text_edit->setGeometry(QRect(104, 20, 341, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_from_name->setText(QApplication::translate("MainWindow", "From:", Q_NULLPTR));
    } // retranslateUi
